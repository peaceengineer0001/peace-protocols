...
TOOLS: List[Dict[str, Any]] = [
    {"name": "open_task_space", "description": "Open an isolated task space", "inputSchema": {"type": "object"}},
    {"name": "navigate", "description": "Navigate to a URL", "inputSchema": {"type": "object"}},
    {"name": "observe", "description": "Snapshot/screenshot the page", "inputSchema": {"type": "object"}},
    {"name": "act", "description": "Click/type/scroll", "inputSchema": {"type": "object"}},
    {"name": "eval_js", "description": "Evaluate JS via CDP", "inputSchema": {"type": "object"}},
]
...
class EgoLiteAdapter:
    """Wrap Ego-Lite as an MCP server on the Peace Protocols bus."""
    ...
    async def call_tool(self, name: str, arguments: Dict[str, Any]) -> Any:
        if not self._connected:
            raise RuntimeError("ego-lite: adapter not connected")
        raise NotImplementedError(
            "ego-lite.call_tool('%s') requires the live upstream service. "
            "See integrations/ego_lite/README.md for setup." % name
        )
...
def build(spec: Any = None, **kwargs: Any) -> "EgoLiteAdapter":
    """Factory used by the connection pool's ``client_factory``."""
    return EgoLiteAdapter(spec, **kwargs)
